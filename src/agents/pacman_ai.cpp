...
#include <climits> // 新增：用于INT_MAX定义
#include <ctime>
...
Direction PacmanAI::getNearestFoodDirection(const VisibleArea &visibleArea, int pacmanX, int pacmanY,
                                            const std::vector<Direction> &validMoves) const {
